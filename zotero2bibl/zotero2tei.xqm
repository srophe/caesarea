...
return     
    <TEI xmlns="http://www.tei-c.org/ns/1.0">
        <teiHeader>
            ...
            <revisionDesc>
                <change who="{replace($zotero2tei:base-uri,'/bibl','')}/documentation/editors.xml#autogenerated" when="{current-date()}">CREATED: This bibl record was autogenerated from a Zotero record.</change>
            </revisionDesc>
        </teiHeader>
        <text>
            <body>
...
let $tei-monogr := if($recordType = "analytic" or $recordType = "monograph") then
                    <monogr>{
                        ...
                        if ($tei-analytic) then $itemTypeNote else ($all-idnos, $itemTypeNote),
